...
\define@key[psset]{pst-node}{offset}{\psset[pst-node]{offsetA=#1}\let\psk@offsetB\psk@offsetA}
...
\define@key[psset]{pst-node}{ncurv}{\psset[pst-node]{ncurvA=#1}\let\psk@ncurvB\psk@ncurvA}
\psset[pst-node]{ncurv=.67,arcangle=8,angle=0,offset=0pt}
%
\define@key[psset]{pst-node}{lineAngle}{\psset[pst-node]{armB=0.5}\edef\psk@lineAngle{#1}}%
...
\define@key[psset]{pst-node}{arrows}{%
  \begingroup
    \pst@activearrows
    \xdef\pst@tempg{#1}%
  \endgroup
