...
\define@key[psset]{pst-node}{offset}{\psset{offsetA=#1}\let\psk@offsetB\psk@offsetA}
...
\define@key[psset]{pst-node}{ncurv}{\psset{ncurvA=#1}\let\psk@ncurvB\psk@ncurvA}
\psset{ncurv=.67,arcangle=8,angle=0,offset=0pt}
%
\define@key[psset]{pst-node}{lineAngle}{\psset{armB=0.5}\edef\psk@lineAngle{#1}}%
\psset{lineAngle=0}%
%
%
