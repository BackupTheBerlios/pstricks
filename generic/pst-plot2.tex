...
%% COPYRIGHT 2004 by Herbert Voss, <voss _at_ PSTricks.de>.
%%
...
\define@key[psset]{}{xyAxes}[true]{\psset{xAxis=true,yAxis=true}}%
%
...
%
\define@key[psset]{}{xyLabel}{\def\psk@xLabel{#1}\def\psk@yLabel{#1}}
...
\define@key[psset]{}{xylogBase}{\edef\psk@xlogBase{#1}\edef\psk@ylogBase{#1}}%
%
%logLines=all|x|y|none  (0,1,2,3)
\define@key[psset]{}{logLines}{\pst@expandafter\logLines@ii{#1}\@nil\psk@logLines}
...
% For polar plots
\newif\ifpolarplot
\define@key[psset]{}{polarplot}{\@nameuse{polarplot#1}}
%
...
%\define@key[psset]{}{algebraic}[false]{\@nameuse{Pst@algebraic#1}}%
%
\def\@rkiv{rk4}%
\def\@adams{adams}%
\def\@undef{undef}%
...
\def\pst@ticks#1#2#3#4{%
  ...
  \end@SpecialObj}
%
\define@key[psset]{}{ticks}{\pst@expandafter\ticks@i{#1}\@nil\psk@ticks}
\def\ticks@i#1#2\@nil#3{%
  ...
  \fi\fi\fi\fi}
%
\define@key[psset]{}{labels}{\pst@expandafter\ticks@i{#1}\@nil\psk@labels}
%
...
\def\tickstyle@i#1#2\@nil{%
  ...
  \fi\fi\fi}
%
\define@key[psset]{}{subticks}{\edef\psk@xsubticks{#1}\edef\psk@ysubticks{#1}}
\define@key[psset]{}{xsubticks}{\edef\psk@xsubticks{#1}}
\define@key[psset]{}{ysubticks}{\edef\psk@ysubticks{#1}}
%
\define@key[psset]{}{subticksize}{\edef\psk@xsubticksize{#1}\edef\psk@ysubticksize{#1}}
...
%
\define@key[psset]{}{tickcolor}{\edef\psk@xtickcolor{#1}\edef\psk@ytickcolor{#1}}
\define@key[psset]{}{xtickcolor}{\edef\psk@xtickcolor{#1}}
\define@key[psset]{}{ytickcolor}{\edef\psk@ytickcolor{#1}}
\define@key[psset]{}{subtickcolor}{\edef\psk@xsubtickcolor{#1}\edef\psk@ysubtickcolor{#1}}
