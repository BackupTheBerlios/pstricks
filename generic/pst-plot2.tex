...
\endgroup
%
\define@key[psset]{pst-plot}{ignoreLines}{\def\psk@ignoreLines{#1}}
\define@key[psset]{pst-plot}{nStep}{\def\psk@nStep{#1}}
\define@key[psset]{pst-plot}{nStart}{\def\psk@nStart{#1}}
\define@key[psset]{pst-plot}{nEnd}{\def\psk@nEnd{#1}}
\define@key[psset]{pst-plot}{xStep}{\def\psk@xStep{#1}}
\define@key[psset]{pst-plot}{yStep}{\def\psk@yStep{#1}}
%
...
%
\define@key[psset]{pst-plot}{plotNo}{\def\psk@plotNo{#1}}
\define@key[psset]{pst-plot}{plotNoMax}{\def\psk@plotNoMax{#1}}
%
...
\def\readdata@i[#1]#2#3{{%
  ...
  \else
    ...
    \loop \ifnum\the\pst@cnta<\psk@ignoreLines
      ...
      \read1 to \pst@tempa
    \repeat
    \typeout{>>> ignored \the\pst@cnta\space data lines}
