...
\section{Fill style}
%--------------------------------------------------------------------------------------
There is one new option \verb+hatchstyle+ with three possible values:
%
\begin{verbatim}
solid | dotted | dashed
\end{verbatim}

\begin{showexample}[width=5cm,wide=true]
\begin{pspicture}(5,5)
  \psframe[fillstyle=hlines](5,5)
  \pscircle[fillstyle=solid,fillcolor=white](2.5,2.5){1.5}
\end{pspicture}
\end{showexample}

\begin{showexample}[width=5cm,wide=true]
\begin{pspicture}(5,5)
  \psframe[fillstyle=hlines,hatchstyle=dotted](5,5)
  \pscircle[fillstyle=solid,fillcolor=white](2.5,2.5){1.5}
\end{pspicture}
\end{showexample}
...
\begin{showexample}[width=5cm,wide=true]
\begin{pspicture}(5,5)
  \psframe[fillstyle=hlines,hatchstyle=dashed,dash=0.3 0.15](5,5)
  \pscircle[fillstyle=solid,fillcolor=white](2.5,2.5){1.5}
\end{pspicture}
\end{showexample}
...
\begin{showexample}[width=5cm,wide=true]
\begin{pspicture}(5,5)
  \psframe[fillstyle=vlines,hatchstyle=dashed,hatchsep=0.4,hatchcolor=red](5,5)
  \pscircle[fillstyle=solid,fillcolor=white](2.5,2.5){1.5}
\end{pspicture}
\end{showexample}
...
This is another type of an arrow and abbreviated with \verb+H+ or with \verb+h+. For the \verb+H+ type 
the length and width of the hook
...
\begin{showexample}[width=7.25cm]
...
\bigskip
For the arrowtype \verb+h+ the width and length are set by \verb+arrowlength+ and \verb+arrowsize+
parameters.

\begin{showexample}[width=3cm]
\begin{pspicture}(3,4)
\psline[linecolor=blue,arrowsize=-3mm]{h->}(0,3.5)(3,3.5)
\psline[linecolor=red,arrowlength=2,arrowsize=3mm]{h->}(0,2.5)(3,2.5)
\psline[arrowsize=-3mm]{h-h}(0,1.5)(3,1.5)
\psline{h-h}(0,0.5)(3,0.5)
\end{pspicture}
\end{showexample}
...
\begin{pspicture}(0,-0.2)(3,0.2)
\psline[linecolor=red,arrowscale=3,arrowinset=0]{<->}(0,0)(3,0)
\end{pspicture}
\end{showexample}

\begin{showexample}[width=3.5cm]
\begin{pspicture}(0,-0.2)(3,0.2)
\psline[linecolor=red,arrowscale=3,arrowinset=0,ArrowFill=false]{<->}(0,0)(3,0)
\end{pspicture}
\end{showexample}

\begin{showexample}[width=3.5cm]
\begin{pspicture}(0,-0.2)(3,0.2)
\psline[linecolor=red,arrowscale=3,arrowinset=0,arrowsize=0.5,ArrowFill=false]{<->}(0,0)(3,0)
\end{pspicture}
\end{showexample}
...
\begin{pspicture}(6,2)
\psset{arrowscale=2,ArrowFill=true}
\psline[linearc=0.5,ArrowInside={-|}]{<->}%
    (0,2)(2,0)(3,2)(4,0)(6,2)
\end{pspicture}
\end{showexample}
...
\section{\CMD{psarc}}
%--------------------------------------------------------------------------------------
The changes to the code of \verb+psarc@v+ now allows to draw the arc with a negative
radius, which is only important for the \verb+\nccircle+ macro of(\verb+\pst-node+) to
draw the lines clockwise below a node. But this new feature of a negative radius can also be used
with \verb+\psarc+


\begin{showexample}[pos=a]
  \begin{pspicture}(5,5)\psgrid[subgriddiv=0,gridcolor=lightgray]
    \psdot[dotscale=2](2.5,2.5)
    \psarc[arrowscale=2]{->}(2.5,2.5){2}{0}{135}
    \psarc[linecolor=red,arrowscale=2]{->}(2.5,2.5){-2}{0}{135}
  \end{pspicture}
\hspace{1cm}
  \begin{pspicture}(5,5)\psgrid[subgriddiv=0,gridcolor=lightgray]
    \psdot[dotscale=2](2.5,2.5)
    \psarcn[arrowscale=2]{->}(2.5,2.5){2}{0}{135}
    \psarcn[linecolor=red,arrowscale=2]{->}(2.5,2.5){-2}{0}{135}
  \end{pspicture}
\end{showexample}
