...
%--------------------------------------------------------------------------------------
\section{\CMD{nccircle}}
%--------------------------------------------------------------------------------------
The changes to the code of \verb+psarc@v+ (\verb+pstricks.tex+) now allows to draw node loops with
\verb+\nccircle+ clockwise below a node, which needs a negative radius.

\begin{showexample}[width=8cm]
  \psscalebox{1.5}{
  \circlenode{A}{A}
  \nccircle{->}{A}{1.5em}
  \nbput{foo}
...
%--------------------------------------------------------------------------------------
\section{\CMD{nccurve}, \CMD{pccurve} and inside arrows}
%--------------------------------------------------------------------------------------
